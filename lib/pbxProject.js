...
pbxProject.prototype.addAssetTags = function(assetTagNames, resourcesFolder) {
    var project = this.getFirstProject()['firstProject'];
    if (project['attributes'] === undefined) {
        project['attributes'] = {};
    }
...
//    console.log(this.getFirstProject())
    ...
    for( let i=0; i < assetTagNames.length; i++) {
        var assetTagName = sanitiseTag(assetTagNames[i]);
